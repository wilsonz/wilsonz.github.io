...
Time Complexity:   O(m,n)                                                                                                     Space Complexity:  O(1)                                                                                                      One last thing: take extra caution of the following cases:                                                                           1. When one list is longer than the other:                                                                                              L1 = [0, 1]     L2 = [0, 1, 2]                                                                                       2. when one list is empty:                                                                                                              L1 = []         L2 = [0, 1]                                                                                           3. The sum could have an extra carry of one at the end:                                                                                L1 = [9,9]      L2 = [1]								
